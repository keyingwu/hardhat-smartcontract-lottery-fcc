# Hardhat Smartcontract Lottery (Raffle) FCC Learning from Patric Collins

- [Hardhat Smartcontract Lottery (Raffle) FCC Learning from Patric Collins](#hardhat-smartcontract-lottery-raffle-fcc-learning-from-patric-collins)
...
```shell
git clone https://github.com/sheepskin1/hardhat-smartcontract-lottery-fcc
